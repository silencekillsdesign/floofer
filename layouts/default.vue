...
const tabs = [
  { to: "/", label: "Swipe", icon: "M13.5 3c-1 2.6-.4 4.4.9 6 .9 1 1.6 2.2 1.6 3.7A5.5 5.5 0 0 1 10.5 18 5.5 5.5 0 0 1 5 12.7c0-2.6 1.6-4 2.8-5.4C9.4 5.5 10.4 4.2 10.5 2c1.7.7 2.6 1.6 3 1z" },
