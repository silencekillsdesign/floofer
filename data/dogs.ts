...
export const DOGS: Dog[] = [
  listing({
    ...
    risk: "high", riskReason: "Shelter over capacity — transfer list", riskCategory: "capacity", daysLeft: 9,
  ...
  listing({
    ...
    risk: "high", riskReason: "Behavior flag — final review pending", riskCategory: "behavior", daysLeft: 5,
  ...
  listing({
    ...
    risk: "high", riskReason: "Long-stay — 140+ days, kennel stress", riskCategory: "long-stay", daysLeft: 14,
